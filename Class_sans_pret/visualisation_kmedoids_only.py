...
def small_visu_kmedoids_only():
    ...
    for taille in TAILLE:
        ...
        for i in range(MIN_CLUSTERS, MAX_CLUSTERS + 1):
            ...
            _, km = kmedoids_only(np.copy(dataset), i, norm_bool=norm_bool, liss_bool=liss_bool, crop_bool=crop_bool)
